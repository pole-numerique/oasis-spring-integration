...
public class DCResourceTypeAdapterTest {
    ...
    public void testSerialization() throws Exception {
        ...
        assertEquals("http://data-test.oasis-eu.org/dc/type/citizenkin.procedure.envelope/3333_4444_5555", o.get("uri").getAsString());
    ...
    public void testSerializationWithGson() {
        ...
        assertNotNull(json);
        assertTrue(json.contains("\"uri\":\"http://data-test.oasis-eu.org/dc/type/citizenkin.procedure.envelope/3333_4444_5555"));
